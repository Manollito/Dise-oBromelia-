...
public class PreferenceAlgorithm implements SelectionAlgorithm{

    public void rankPhotos(JSONObject jsonPhotos) {
    
        // Realiza el ranking de las fotos por preferencias
        ...
        for (int i = 0; i < totalPhotos.length(); i++) {
            for (int i = 0; i < totalPhotos.length(); i++) {
                ...
                if(jsonTemporal.get("likes")<totalPhotos.get(i).get("likes")){
